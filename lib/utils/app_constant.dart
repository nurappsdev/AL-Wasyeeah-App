...
class AppConstants {
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(
        languageName: 'bangla', countryCode: 'BD', languageCode: 'bd'),
  ];

  static const String publishAbleKey =
      "pk_test_51OVVcyFiDaJ8bQBjyv4imMqxSbWPo07q81rTzpcw7yUIlXiUBfFThslht2LC8uD5Ec5MuiW1SPyrasy8N6v3MfyJ00d1bz549n";
