class AppImages {
  ...
  static const String initialRouteBackgroundImage =
      "$path/initial_route_bg_image.png";
  ...
  static const String pomijIconBottomUnSelect =
      "$path/pmoji_bottom_unselected.png";

  static const String pomijCartBottomSelect = "$path/pmoji_cart_selected.png";
  static const String pomijCartBottomUnSelect =
      "$path/pmoji_cart_unselected.png";

  static const String profileIconBottomSelect = "$path/profile_selected.png";
  static const String profileIconBottomUnSelect =
      "$path/profile_unselected.png";
