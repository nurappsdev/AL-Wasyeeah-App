  ...
  Widget build(BuildContext context) {
    return PinCodeTextField(
      ...
      pinTheme: PinTheme(
        ...
        activeFillColor: AppColors.primaryColor.withValues(alpha: 0.1),
        inactiveFillColor: AppColors.primaryColor.withValues(alpha: 0.1),
        selectedFillColor: AppColors.primaryColor.withValues(alpha: 0.1),
      ),
