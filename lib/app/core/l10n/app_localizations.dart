...
abstract class AppLocalizations {
  ...
  /// No description provided for @message_send_success.
  ///
  /// In en, this message translates to:
  /// **'Message Send Success'**
  String get message_send_success;

  /// No description provided for @get_in_touch_with_us.
  ///
  /// In en, this message translates to:
  /// **'Get in Touch With Us'**
  String get get_in_touch_with_us;
  ...
  /// No description provided for @mission_title.
  ///
  /// In en, this message translates to:
  /// **'Our Mission'**
  ...
  /// No description provided for @member_1_name.
  ///
  /// In en, this message translates to:
  /// **'FAHAD BIN BADIUL ALAM'**
  String get member_1_name;

  /// No description provided for @member_1_designation.
  ///
  /// In en, this message translates to:
  /// **'Managing Director'**
  String get member_1_designation;

  /// No description provided for @member_1_description.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @member_2_name.
  ///
  /// In en, this message translates to:
  /// **'MD.YEASIN FOISAL'**
  String get member_2_name;

  /// No description provided for @member_2_designation.
  ///
  /// In en, this message translates to:
  /// **'Business Development Strategist'**
  String get member_2_designation;

  /// No description provided for @member_2_description.
  ///
  /// In en, this message translates to:
  /// **'Yeasin Emily ensures smooth operations, making every journey seamless and enjoyable.'**
  String get member_2_description;

  /// No description provided for @member_3_name.
  ///
  /// In en, this message translates to:
  /// **'Nur Islam Rajib'**
  String get member_3_name;

  /// No description provided for @member_3_designation.
  ///
  /// In en, this message translates to:
  /// **'App Developer'**
  String get member_3_designation;

  /// No description provided for @member_3_description.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @member_4_name.
  ///
  /// In en, this message translates to:
  /// **'Khandokar Zaeem Hasan'**
  String get member_4_name;

  /// No description provided for @member_4_designation.
  ///
  /// In en, this message translates to:
  /// **'Software Engineer'**
  String get member_4_designation;

  /// No description provided for @member_4_description.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @member_5_name.
  ///
  /// In en, this message translates to:
  /// **'Shahid Ullah Bahar'**
  String get member_5_name;

  /// No description provided for @member_5_designation.
  ///
  /// In en, this message translates to:
  /// **'Software Developer'**
  String get member_5_designation;

  /// No description provided for @member_5_description.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @member_6_name.
  ///
  /// In en, this message translates to:
  /// **'Safayet Hossain'**
  String get member_6_name;

  /// No description provided for @member_6_designation.
  ///
  /// In en, this message translates to:
  /// **'UI/UX Designer'**
  String get member_6_designation;

  /// No description provided for @member_6_description.
  ///
  /// In en, this message translates to:
