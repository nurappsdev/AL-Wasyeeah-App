...
import 'package:al_wasyeah/app/models/menus/user_menus_model.dart';
import 'package:al_wasyeah/app/models/prayer_model.dart';
import 'package:al_wasyeah/app/models/salat_time_response_model.dart';
...
class HomeController extends GetxController {
  ...
  Future<void> changePass(String oldPassword, String newPassword, String confirmPassword) async {
    ...
    var response = await ApiClient.postData("${ApiConstants.changePassAPI}", body, headers: headers);
