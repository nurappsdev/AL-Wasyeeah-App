  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(widget.user.name ?? AppLocalizations.of(context)!.witness),
        centerTitle: true,
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDialogRow(Icons.email, AppLocalizations.of(context)!.email,
                  widget.user.email ?? AppLocalizations.of(context)!.n_a),
              _buildDialogRow(Icons.person, "Father Name",
                  widget.user.fatherName ?? AppLocalizations.of(context)!.n_a),
              _buildDialogRow(Icons.phone, AppLocalizations.of(context)!.mobile,
              ...
              _buildDialogRow(Icons.work, "Profession",
                  widget.user.profession ?? AppLocalizations.of(context)!.n_a),
              ...
              Center(
                child: ElevatedButton(
                  ...
                  child: Text(AppLocalizations.of(context)!.access_control),
                ),
              ),
            ],
          ),
